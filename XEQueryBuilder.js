...
var XEqueryBuilderDB = {
    "type":{
        "operators":["=","!=","IN"],
        "constants":["TYPE_DAMAGE","TYPE_MISS","TYPE_HEAL","TYPE_AURA","TYPE_DEATH","TYPE_CAST","TYPE_DISPEL","TYPE_GAIN",
            "TYPE_ENCHANT","TYPE_DURABILITY","TYPE_SUMMON","TYPE_OTHER"],
        "description":"Event type"
    },
    "fullType":{
        "operators":["=","!=","IN"],
        "constants":["SWING_DAMAGE","RANGE_DAMAGE","SPELL_DAMAGE","SPELL_PERIODIC_DAMAGE","DAMAGE_SPLIT","DAMAGE_SHIELD",
            "ENVIRONMENTAL_DAMAGE","SPELL_BUILDING_DAMAGE","SWING_MISSED","RANGE_MISSED","SPELL_MISSED","SPELL_PERIODIC_MISSED",
            "DAMAGE_SHIELD_MISSED","SPELL_HEAL","SPELL_PERIODIC_HEAL","SPELL_BUILDING_HEAL","SPELL_AURA_APPLIED",
            "SPELL_AURA_APPLIED_DOSE","SPELL_AURA_REMOVED","SPELL_AURA_REMOVED_DOSE","SPELL_EXTRA_ATTACKS","SPELL_AURA_REFRESH",
            "PARTY_KILL","UNIT_DIED","UNIT_DESTROYED","SPELL_INSTAKILL","SPELL_CAST_START","SPELL_CAST_SUCCESS","SPELL_CAST_FAILED",
            "SPELL_INTERRUPT","SPELL_DISPEL","SPELL_DISPEL_FAILED","SPELL_STOLEN","SPELL_AURA_BROKEN","SPELL_AURA_BROKEN_SPELL",
            "SPELL_ENERGIZE","SPELL_DRAIN","SPELL_LEECH","SPELL_PERIODIC_ENERGIZE","SPELL_PERIODIC_DRAIN","SPELL_PERIODIC_LEECH",
            "ENCHANT_APPLIED","ENCHANT_REMOVED","SPELL_DURABILITY_DAMAGE","SPELL_DURABILITY_DAMAGE_ALL","SPELL_SUMMON","SPELL_CREATE",
            "SPELL_RESURRECT"],
        "description":"Full event type"
    },
    "missType":{
        "operators":["=","!=","IN"],
    ...
    "school":{
        "operators":["=","!=","IN"],
        "constants":["PHYSICAL","HOLY","FIRE","NATURE","FROST","SHADOW","ARCANE"],
        "description":"Spell school"
    },
    "sourceType":{
        "operators":["=","!=","IN"],
        "constants":["'Player'","'Creature'","'Pet'","'Vehicle'","'Unknown'"],
        "description":"Source actor type"
    },
    "targetType":{
        "operators":["=","!=","IN"],
        "constants":["'Player'","'Creature'","'Pet'","'Vehicle'","'Unknown'"],
        "description":"Target actor type"
    },
    "sourceReaction":{
        "operators":["=","!=","IN"],
        "constants":["REACTION_FRIENDLY","REACTION_NEUTRAL","REACTION_HOSTILE"],
        "description":"Source actor reaction"
    },
    "targetReaction":{
        "operators":["=","!=","IN"],
        "constants":["REACTION_FRIENDLY","REACTION_NEUTRAL","REACTION_HOSTILE"],
        "description":"Target actor reaction"
    },
    "sourceIcon":{
        "operators":["=","!=","IN"],
        "constants":["ICON_STAR","ICON_CIRCLE","ICON_DIAMOND","ICON_TRIANGLE","ICON_MOON","ICON_SQUARE","ICON_CROSS","ICON_SKULL"],
        "description":"Source actor raid icon"
    },
    "targetIcon":{
        "operators":["=","!=","IN"],
        "constants":["ICON_STAR","ICON_CIRCLE","ICON_DIAMOND","ICON_TRIANGLE","ICON_MOON","ICON_SQUARE","ICON_CROSS","ICON_SKULL"],
        "description":"Target actor raid icon"
    },
    "isCritical":{
        "operators":["=","!="],
        "constants":["TRUE","FALSE"],
        "description":"Event is critical"
    },
    "isCrushing": {
        "operators": ["=", "!="],
        "constants": ["TRUE", "FALSE"],
        "description": "Event is crushing"
    },
    "isGlancing": {
        "operators": ["=", "!="],
        "constants": ["TRUE", "FALSE"],
        "description": "Event is glancing"
    },
    "spell": {
        "operators": ["=", "!=", "IN"],
        "inputType": "string",
    ...
    "extraSpell": {
        "operators": ["=", "!=", "IN"],
        "inputType": "string",
        "description": "Extra spell"
    },
    "extraSpellID": {
        "operators": ["=", "!=", "IN"],
        "inputType": "number",
        "description": "Extra spell ID"
    },
    "amount": {
        "operators": ["=", "!=", "IN", ">", "<", ">=", "<="],
        "inputType": "number",
    ...
    "absorbed": {
        "operators": ["=", "!=", "IN", ">", "<", ">=", "<="],
        "inputType": "number",
        "description": "Event amount absorbed"
    },
    "blocked": {
        "operators": ["=", "!=", "IN", ">", "<", ">=", "<="],
        "inputType": "number",
        "description": "Event amount blocked"
    },
    "resisted": {
        "operators": ["=", "!=", "IN", ">", "<", ">=", "<="],
        "inputType": "number",
        "description": "Event amount resisted"
    },
    "missAmount": {
        "operators": ["=", "!=", "IN", ">", "<", ">=", "<="],
        "inputType": "number",
        "description": "Event amount missed"
    },
    "overheal": {
        "operators": ["=", "!=", "IN", ">", "<", ">=", "<="],
        "inputType": "number",
        "description": "Event amount overheal"
    },
    "overkill": {
        "operators": ["=", "!=", "IN", ">", "<", ">=", "<="],
        "inputType": "number",
        "description": "Event amount overkill"
    },
    "healingDone": {
        "operators": ["=", "!=", "IN", ">", "<", ">=", "<="],
        "inputType": "number",
        "description": "WoL healing done amount (amount - overheal + absorbed)"
    },
    "damageTaken": {
        "operators": ["=", "!=", "IN", ">", "<", ">=", "<="],
        "inputType": "number",
        "description": "WoL damage taken amount"
    },
    "sourceID": {
        "operators": ["=", "!=", "IN"],
        "inputType": "number",
        "description": "WoL source actor ID"
    },
    "sourceUID": {
        "operators": ["=", "!=", "IN"],
        "inputType": "number",
        "description": "WoL merged source actor ID"
    },
    "masterSourceUID": {
        "operators": ["=", "!=", "IN"],
        "inputType": "number",
        "description": "WoL merged actor ID of source's master"
    },
    "sourceMobID": {
        "operators": ["=", "!=", "IN"],
        "inputType": "number",
        "description": "Source actor mob (WoW) ID"
    },
    "sourceName": {
        "operators": ["=", "!=", "IN"],
        "inputType": "string",
        "description": "Source actor name"
    },
    "targetID": {
        "operators": ["=", "!=", "IN"],
        "inputType": "number",
        "description": "WoL target actor ID"
    },
    "targetUID": {
        "operators": ["=", "!=", "IN"],
        "inputType": "number",
        "description": "WoL merged target actor ID"
    },
    "mastertargetUID": {
        "operators": ["=", "!=", "IN"],
        "inputType": "number",
        "description": "WoL merged actor ID of target's master"
    },
    "targetMobID": {
        "operators": ["=", "!=", "IN"],
        "inputType": "number",
        "description": "Target actor mob (WoW) ID"
    },
    "targetName": {
        "operators": ["=", "!=", "IN"],
        "inputType": "string",
    ...
    "healID": {
        "operators": ["=", "!=", "IN"],
        "inputType": "number",
        "description": "WoL source actor ID (Shield support)"
    },
    "healUID": {
        "operators": ["=", "!=", "IN"],
        "inputType": "number",
        "description": "WoL merged source actor ID (Shield support)"
    },
    "masterhealUID": {
        "operators": ["=", "!=", "IN"],
        "inputType": "number",
        "description": "WoL merged actor ID of source's master (Shield support)"
    },
    "healSpell": {
        "operators": ["=", "!=", "IN"],
        "inputType": "string",
        "description": "Spell (Shield support)"
    },
    "healSpellID": {
        "operators": ["=", "!=", "IN"],
        "inputType": "number",
        "description": "Spell ID (Shield support)"
    }
};
